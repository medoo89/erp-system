    ...
    <div class="job-premium-wrap">
        <section class="job-premium-hero">
            <div class="job-premium-hero-inner">
                <div>
                    <div class="job-premium-breadcrumb">Recruitment › Job Openings › Create</div>
                    <div class="job-premium-title">Create Job Opening</div>
                    <div class="job-premium-subtitle">
                        Create a new job opening and connect it with client, project, application template, content, and expiry date.
                    </div>
                </div>
        ...
        <section class="job-form-shell">
            ...
            <div class="job-actions-bottom">
                <button type="button" wire:click="create(false)" class="job-create-btn">Create</button>
                <button type="button" wire:click="create(true)" class="job-create-another-btn">Create & create another</button>
