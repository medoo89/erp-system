<x-filament-panels::page>
    ...
    <style>
        ...
        /* SADA TEMPLATE CREATE ACTIONS FIX */
        ...
        .tpl-create-another-btn:hover,
        .tpl-cancel-btn:hover {
            transform: translateY(-1px) !important;
        }

        .dark .tpl-create-another-btn,
        .dark .tpl-cancel-btn {
            background: rgba(15,23,42,.92) !important;
            color: #f8fafc !important;
            border-color: rgba(76,167,168,.18) !important;
    ...
    <div class="tpl-form-wrap">
        <section class="tpl-form-hero">
            <div class="tpl-form-hero-inner">
                <div>
                    <div class="tpl-form-breadcrumb">Admin Settings › Templates › Create</div>
                    <div class="tpl-form-title">Create Template</div>
                    <div class="tpl-form-subtitle">
                        Build a new application template and define which fields will appear in the public job application form.
                    </div>
                </div>
        ...
        <section class="tpl-form-shell">
            ...
            <div class="tpl-form-actions-bottom">
                <button type="button" wire:click="create(false)" class="tpl-create-btn">
                    Create
                </button>

                <button type="button" wire:click="create(true)" class="tpl-create-another-btn">
