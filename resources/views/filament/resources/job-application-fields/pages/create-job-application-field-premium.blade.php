    ...
    <div class="af-form-wrap">
        <section class="af-form-hero">
            <div class="af-form-hero-inner">
                <div>
                    <div class="af-form-breadcrumb">Admin Settings › Application Fields › Create</div>
                    <div class="af-form-title">Create Application Field</div>
                    <div class="af-form-subtitle">
                        Add a new reusable field for public job application forms and control its type, group, visibility, and required behavior.
                    </div>
                </div>
        ...
        <section class="af-form-shell">
            ...
            <div class="af-form-actions-bottom">
                <button type="button" wire:click="create(false)" class="af-create-btn">
                    Create
                </button>

                <button type="button" wire:click="create(true)" class="af-create-another-btn">
